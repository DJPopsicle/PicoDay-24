...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['set Cam Zoomin', "Set whether or not the camera lerps to the default pos.\nValue 1: true/false | yes/no\nValue 2: Nothin"],
		['Zoom Cam', "Set camera zoom.\nValue 1: Zoom\nValue 2: Reset (true/false | yes/no)"],
